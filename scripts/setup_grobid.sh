...
unzip 0.7.3.zip
sed -i 's/https\://services.gradle.org/distributions/gradle-7.2-bin.zip/https\://mirrors.cloud.tencent.com/gradle/gradle-7.2-bin.zip/g' $HOME/grobid-0.7.3/gradle/wrapper/gradle-wrapper.properties
